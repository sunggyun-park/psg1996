...
with col2:
    ...
    st.markdown("")
    st.markdown("")
    st.markdown("<h3 style='text-align: right; color: black; margin: 5px 0;'>이름: 박XX</h3>", unsafe_allow_html=True)
    st.markdown("<h3 style='text-align: right; color: black; margin: 5px 0;'>전공: 재난소방안전</h3>", unsafe_allow_html=True)
    st.markdown("<h3 style='text-align: right; color: black; margin: 5px 0;'>학교: XX대학교 안전대학원</h3>", unsafe_allow_html=True)
...
with col3:
    st.markdown("### 학력사항")
    st.markdown('<div class="detail-content">- XX융합고등학교<br>- 국가공무원교육원 환경훈련과 정보처리반<br>- 고려사이버대학교 <strong>소방방재학과</strong><br>- XX대학교 <strong>안전대학원</strong> 재난소방안전학 재학</div>', unsafe_allow_html=True)

    st.markdown("### 경력사항")
    st.markdown('<div class="detail-content">- 건강보험공단 청년인턴<br>- 대화면학 공공 훈<br>- 대한민국 공공 부사관</div>', unsafe_allow_html=True)

    st.markdown("### 수상경력")
    st.markdown('<div class="detail-content">- XXXXX상<br>- ●●●●●●상<br>- ■■■■■■■■상</div>', unsafe_allow_html=True)
