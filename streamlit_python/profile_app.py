...
# 배경 이미지 설정
bg_image = get_base64_of_bin_file("streamlit_python/background.jpeg")

if bg_image:
    st.markdown(f"""
    <style>
    .stApp {{
        background-image: url("streamlitstreamlit_python:image/jpeg;base64,{bg_image}");
...
img_path = os.path.abspath("streamlit_python/성균.png")
